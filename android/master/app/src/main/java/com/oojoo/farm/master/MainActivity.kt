...
fun MainApp() {
    ...
    Scaffold(
        bottomBar = {
            if (showBottomBar) {
                // 컴팩트 커스텀 하단바 — Material3 NavigationBar 기본 높이(80dp) 대신 56dp
                Surface(
                        ...
                        items.forEach { item ->
                            Column(
                                ...
                                Icon(
                                    ...
                                    tint = if (currentRoute == item.route) OojooTheme.Green else OojooTheme.Muted,
                                ...
                                Text(
                                    ...
                                    color = if (currentRoute == item.route) OojooTheme.Green else OojooTheme.Muted
                                )
                            }
                        }
                    }
