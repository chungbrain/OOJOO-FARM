...
class AppStrings internal constructor(private val context: Context) {
    ...
    val monitoringSettings: String get() = context.getString(R.string.monitoring_settings)
    val aiModelLabel: String get() = context.getString(R.string.ai_model_label)
    val heuristicModel: String get() = context.getString(R.string.heuristic_model)
    ...
    val photoCapture: String get() = context.getString(R.string.photo_capture)
    val photoSending: String get() = context.getString(R.string.photo_sending)
    val photoSentWaiting: String get() = context.getString(R.string.photo_sent_waiting)
    val photoDone: String get() = context.getString(R.string.photo_done)
    val photoCapturedPrefix: String get() = context.getString(R.string.photo_captured_prefix)
    val photoCapturedSuffix: String get() = context.getString(R.string.photo_captured_suffix)
    val videoCaptureBtn: String get() = context.getString(R.string.video_capture_btn)
